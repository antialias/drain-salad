...
**Photography note:** *This chapter should be highly visual. Include a large, annotated photograph of a composed Drain Salad with each of the six elements labeled. Add macro shots showing texture contrasts: crispy vs. soft, bright vs. deep. Consider a "build-your-bowl" visual matrix showing which components pair well together. The tone should be instructional but elegant—like a design textbook for food.*
