...
The book is called _Drain Salad_. I know. You bought a book called _Drain Salad_ and now you're sitting here wondering if this is an elaborate prank, or if I've genuinely lost my mind, or possibly both. These are fair questions.
...
What we're doing—what this entire book is about—is intercepting scraps _before_ they reach the drain. That's the "Clean-Catch" part. We're catching them upstream, while they're still clean food, before they touch the sink basin or get contaminated by the general disaster zone that is most people's kitchen sinks.

_Legal disclaimer time:_ Kitchen sinks are microbiological nightmares. A 2019 USDA study found that 34% of kitchen sinks test positive for bacterial contamination—more than any other surface. Sinks develop biofilms (sticky bacterial colonies that resist cleaning), become splash zones for aerosolized _Salmonella_ and _Campylobacter_, and generally host a party of pathogens you do not want to eat. The CDC explicitly warns against rinsing raw chicken in sinks for this reason. So: if food has touched the sink basin, the drain, or a drain filter, don't eat it. Compost it. Throw it away. Feed it to your neighbor's chickens. Whatever. Just don't eat it.

_End legal disclaimer._
...
The Clean-Catch Method is built on one simple principle: _intercept scraps before they reach the sink._

Instead of letting edible offcuts fall wherever they may—onto the cutting board, into the sink, circling the drain—we deliberately capture them _upstream_, in a dedicated, food-only container. This keeps scraps in the _food system_ (safe, intentional, hygienic) rather than the _waste system_ (contaminated, haphazard, headed for oblivion).

Think of it as _mise en place_ for your scraps. In a professional kitchen, every ingredient has its place: diced onions in one container, minced garlic in another, herbs picked and ready. The Clean-Catch Method extends this logic to offcuts. Your herb stems don't go in the trash—they go in the scrap bin, where they'll become tomorrow's pesto. Your bread ends don't hit the compost—they go in the bread container, where they'll become croutons or crumbs.

This is not about being fussy. It's about maintaining a clear boundary between _food_ (which we treat with care and intention) and _waste_ (which we discard responsibly). Once that boundary blurs—once scraps touch the sink or trash—they're no longer food. The Clean-Catch Method keeps that boundary bright.
...
#hero-image("../manuscript/images/chapter-03/011_three-configuration-setups.png", caption: [Three Clean-Catch configurations: Minimalist, Counter Station, and Pro Setup])
...
_How it works:_
Place the strainer inside the mixing bowl and set it on your counter, _away from the sink_—ideally next to your cutting board. As you prep, scraps go into the strainer. The bowl underneath catches any liquid. Every 30 minutes (or when you finish prepping), transfer the scraps from the strainer into labeled deli containers (e.g., "Veg Scraps – 10/15," "Bread Ends – 10/14") and refrigerate immediately.

_Pros:_ Cheap, portable, takes up almost no space. You probably already own most of this.
_Cons:_ Requires frequent attention—you can't just let scraps pile up all day. Best for small households or occasional Drain Salad makers.
...
_Pros:_ More ergonomic—scraps flow naturally from board to bowl. Encourages sorting, which makes cooking later easier.
_Cons:_ Takes up counter space. Requires buy-in from anyone else who uses the kitchen.

_Optional upgrades:_
...
- Keep raw animal products (meat, poultry, seafood) completely separate. If you're breaking down a chicken, those scraps (skin, fat, bones) go into a _different_ container, never mixed with vegetable scraps. Ideally, process them immediately into stock.
...
_Pros:_ Maximum efficiency. Sorting happens automatically, so there's less decision fatigue. Great if you're cooking for a family or entertaining frequently.
_Cons:_ Expensive. Requires either custom carpentry or significant adaptation of existing cabinetry. Not renter-friendly.
...
#hero-image("../manuscript/images/chapter-03/012_clean-catch-workflow.png", caption: [The Clean-Catch workflow: from cutting board to container to fridge])
...
- Place your scrap strainer/bowl on the counter, _away from the sink_.
...
- _Edible scraps include:_ vegetable trim, herb stems, bread ends, fruit peels (if organic and washed), wilted greens, allium ends (cleaned), cheese rinds, citrus zest/rinds after juicing.
- _Not edible/not safe:_ anything that touched raw meat or seafood, moldy items, avocado pits, large seeds, allium skins (the papery outer layer—compost those), non-organic citrus peels (often waxed).
...
#hero-image("../manuscript/images/chapter-03/014_properly-labeled-containers.png", caption: [Properly labeled containers with dates and contents clearly marked])
...
+ _Freeze:_ Most scraps freeze well. Bread, vegetable trim, cheese rinds, and citrus peels can all go in the freezer in labeled bags. Frozen scraps are perfect for stocks, stews, and baked dishes.
+ _Cook through:_ Turn scraps into a foundation (stock, crumb-vinaigrette, fermented relish) that lasts longer than the raw scraps would.
...
#hero-image("../manuscript/images/chapter-04/015_before-after-sanitizing.png", caption: [Before and after sanitizing: the visual difference between properly cleaned equipment and contaminated surfaces])
...
#hero-image("../manuscript/images/chapter-03/013_yes-no-items-guide.png", caption: [Visual guide to Yes and No items for the Clean-Catch system])

+ _Anything that touched raw meat, poultry, or seafood._ The risk of cross-contamination is too high. If you're breaking down a chicken, those scraps go directly into a stock pot or the trash—never into the scrap bin with vegetable trim.

+ _Moldy items._ Even if you cut away the visible mold, spores can penetrate deeper than you think. Compost it.

+ _Egg shells._ They can harbor _Salmonella_. Compost or trash.

+ _Anything that smells off, even slightly._ Trust your nose. If it smells wrong, it _is_ wrong.

+ _Non-organic citrus peels (unless thoroughly scrubbed)._ Many are coated with wax or pesticide residue. If you're going to zest them or candy them, make sure they're organic or very well-washed.

+ _Allium skins (the papery outer layers)._ They don't break down well in cooking and add bitterness. Compost them.

+ _Large pits and seeds._ Avocado pits, stone fruit pits, apple cores (the seeds contain trace amounts of cyanide—probably harmless in small amounts, but why risk it?).
...
_Diagnosis:_ Either they weren't fresh to begin with, or they got contaminated during handling.

_Fix:_ Check your source vegetables—if they were already borderline, their scraps won't last either. Also, make sure your scrap containers are truly clean. Run them through the dishwasher or hand-wash with hot, soapy water and dry completely before use.

_Prevention:_ Use scraps from fresh, high-quality ingredients. Don't try to salvage scraps from vegetables that were already past their prime.

=== Problem: I keep forgetting to refrigerate my scraps, and they sit out for hours.

_Diagnosis:_ You need a better workflow.

_Fix:_ Set a timer. Every 30 minutes during active cooking, move scraps to the fridge. Or, keep a small cooler with ice packs on the counter and store scraps there temporarily until you're done cooking.

_Prevention:_ Build the habit. Treat scrap storage with the same seriousness you'd treat raw meat storage.

=== Problem: My family thinks this is gross and won't participate.

_Diagnosis:_ You need better framing (and maybe better-looking containers).

_Fix:_ Don't call it "Drain Salad" around squeamish people. Call it "prep for stock" or "mise for tomorrow's frittata." Invest in attractive, clearly labeled containers—people are more likely to use a system that looks intentional and professional.

_Prevention:_ Cook them something delicious made from scraps. Once they taste how good it is, they'll get on board.

=== Problem: I don't generate enough scraps to make a full dish.

_Diagnosis:_ That's fine! Not every household cooks enough to generate scrap-based meals daily.

_Fix:_ Freeze your scraps in labeled bags until you have enough. A gallon bag of frozen vegetable trim makes excellent stock. A quart of bread ends becomes a pan of savory bread pudding.

_Prevention:_ Adjust your expectations. Drain Salad doesn't have to be an everyday thing. Even once a week, you're diverting pounds of food from the waste stream.
...
_Never, ever mix scraps from raw animal products (meat, poultry, seafood) with vegetable scraps._

Even if you're planning to cook everything later, cross-contamination during storage is a real risk. Bacteria from raw chicken can spread to your vegetable scraps, and unless you cook those vegetables to at least 165°F (the temperature required to kill _Salmonella_), you could make yourself or someone else very sick.

_The rule:_ If you're breaking down a chicken, making fish stock, or trimming a roast, those scraps go into a separate container, labeled "ANIMAL—COOK IMMEDIATELY" or similar. Process them into stock or a cooked dish within a few hours, or freeze them raw in a clearly labeled bag.
...
_Cross-contamination checklist:_
...
You will forget to refrigerate scraps sometimes. You will mix incompatible items. You will let something sit too long and have to throw it out. That's fine. The goal is not zero waste (an impossible standard). The goal is _less_ waste, and more intention.
...
#hero-image("../manuscript/images/chapter-03/010_december-2021-failure.png", caption: [What happens when you skip the Clean-Catch Method: December 2021 scrap failure])
